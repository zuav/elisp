...
;; Copyright (C) 2001, 2007 by Joseph L. Casadonte Jr.
...
;;----------------------------------------------------------------------------
(defvar bar-cursor-insert-cursor-type    'bar
  "Cursor used for insert mode")
(defvar bar-cursor-overwrite-cursor-type 'box
  "Cursor used for overwrite mode")
...
if not passed in."
  (if (and bar-cursor-mode (not overwrite-mode))
	  (bar-cursor-set-cursor-type bar-cursor-insert-cursor-type frame)
	(bar-cursor-set-cursor-type bar-cursor-overwrite-cursor-type frame)))
